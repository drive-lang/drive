module Tape
	...
	#    sees a throwaway arg (same as every Ruby-backed Drive type, e.g. Tape::String/Tape::Array); real
	#    argument binding happens in tapes/statement.tape's `Self(;)` instead.
	class Statement < Instance
		...
		#
		# use_caller_scope/memoize/memoized/_memoized_value live in tapes/statement.tape as ordinary Drive
