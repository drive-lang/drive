module Drive
	...
	class Hot_Reloader
		...
		# @return [[Drive::Interpreter, Object]] the interpreter and its last output, for a one-shot
		...
		# @return [[Drive::Interpreter, Object, Exception, nil]]
		def run_entry
			interpreter                     = Drive::Interpreter.new
			interpreter.serve_in_foreground = false # this class owns the wait loop, not Interpreter#run
			interpreter.live_reload         = true  # mount /_drive/live-reload + inject its client script;
