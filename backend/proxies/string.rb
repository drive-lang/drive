module Prog
	class String < Instance
		...
		def proxy_split * args
			Prog::Array.new value.split(*args)
		end

		def proxy_chars
			Prog::Array.new value.chars
		end
