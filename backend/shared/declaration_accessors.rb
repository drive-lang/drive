# Mixin for Prog::Instance subclasses (external/ruby/*.rb). Forwards unknown method
# calls to @declarations instead of requiring a hand-written getter/setter pair for
# every Backend-declared member. A real method (hand-written, or from a superclass)
